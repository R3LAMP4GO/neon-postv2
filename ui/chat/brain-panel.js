...
async function _brainLoadFacts() {
  ...
  try {
    const facts = await window.neonPost.facts.list();
...
async function brainDeleteFact(id) {
  ...
  try {
    await window.neonPost.facts.delete(id);
...
async function _brainLoadSoul() {
  ...
  try {
    const aspects = await window.neonPost.soul.listAspects();
...
async function brainDeleteSoul(id) {
  ...
  try {
    await window.neonPost.soul.deleteAspect(id);
...
async function _brainLoadLogs() {
  ...
  try {
    const logs = await window.neonPost.dailyLogs.list();
...
async function brainDeleteLog(id) {
  ...
  try {
    await window.neonPost.dailyLogs.delete(id);
